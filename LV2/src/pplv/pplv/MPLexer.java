...
class MPLexer {
    ...
    private static final String ZZ_CMAP_BLOCKS_PACKED_0 = "\11\0\1\1\1\2\2\3\1\2\22\0\1\1\3\0" +
            "\1\4\2\0\1\5\2\0\1\6\1\7\1\0\1\7" +
            "\1\10\1\0\1\11\10\12\1\13\1\14\1\15\1\0" +
            "\1\16\1\17\2\0\4\20\1\21\1\20\24\4\6\0" +
            "\6\20\21\4\1\22\2\4\1\0\1\23\10\0\1\3" +
            "\u01a2\0\2\3\326\0\u0100\3";
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\2\0\1\1\1\2\1\3\2\1\2\4\1\1\1\5" +
            "\2\1\2\0\1\4\2\0\1\6\1\7\1\10\1\11" +
            "\1\4\1\0";
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\24\0\50\0\50\0\74\0\120\0\144\0\170" +
            "\0\214\0\240\0\50\0\264\0\310\0\334\0\360\0\u0104" +
            "\0\214\0\u0118\0\50\0\50\0\50\0\50\0\50\0\u012c";
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\1\3\2\4\1\0\1\5\1\6\2\3\1\7\1\10" +
            "\2\11\1\12\1\13\1\14\1\3\3\5\1\15\6\2" +
            "\1\16\15\2\30\0\1\5\4\0\3\5\4\0\3\5" +
            "\1\0\2\17\2\0\20\17\11\0\3\20\20\0\1\20" +
            "\2\11\1\21\6\0\1\22\11\0\1\20\3\21\26\0" +
            "\1\23\24\0\1\24\12\0\1\25\15\0\6\2\1\16" +
            "\14\2\1\26\5\0\1\27\27\0\3\20\5\0\1\30" +
            "\13\0\3\27\4\0\2\27\11\0\1\30\1\0\3\20" +
            "\10\0";
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\2\0\2\11\6\1\1\11\2\1\2\0\1\1\2\0" +
            "\5\11\1\0";
                ...
                switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                    case 1:
                        System.out.println("line: " + (yyline + 1) + " " + "col: " + (yycolumn + 1) + " " + "match: --"
                                + zzToPrintable(yytext()) + "--");
                        System.out.println(
                                "action [59] { if (yytext() != null && yytext().length() > 0) System.out.println( \"ERROR: \" + yytext() ); }"); {
                    ...
                    case 3:
                        System.out.println("line: " + (yyline + 1) + " " + "col: " + (yycolumn + 1) + " " + "match: --"
                                + zzToPrintable(yytext()) + "--");
                        System.out.println("action [50] { return getKW(); }"); {
                        return getKW();
                    }
                    // fall through
                    case 12:
                    ...
                    case 4:
                        System.out.println("line: " + (yyline + 1) + " " + "col: " + (yycolumn + 1) + " " + "match: --"
                                + zzToPrintable(yytext()) + "--");
                        System.out.println(
                                "action [54] { return new Yytoken( sym.CONST,yytext(), yyline, yycolumn ); }"); {
                    ...
                    case 5:
                        System.out.println("line: " + (yyline + 1) + " " + "col: " + (yycolumn + 1) + " " + "match: --"
                                + zzToPrintable(yytext()) + "--");
                        System.out.println(
                                "action [47] { return new Yytoken( sym.SEMICOLON, yytext(), yyline, yycolumn ); }"); {
                    ...
                    case 6:
                        System.out.println("line: " + (yyline + 1) + " " + "col: " + (yycolumn + 1) + " " + "match: --"
                                + zzToPrintable(yytext()) + "--");
                        System.out.println(
                                "action [45] { return new Yytoken( sym.ASSIGN, yytext(), yyline, yycolumn ); }"); {
                    ...
                    case 7:
                        System.out.println("line: " + (yyline + 1) + " " + "col: " + (yycolumn + 1) + " " + "match: --"
                                + zzToPrintable(yytext()) + "--");
                        System.out.println(
                                "action [43] { return new Yytoken( sym.THEN,   yytext(), yyline, yycolumn ); }"); {
